    ...
    public class ServiceBusHostBuilderTests
    {
        ...
        public async Task UseAzureServiceBus_GivenStaticOptions_ThenValid()
        {
            ...
            var options = new ServiceBusOptions
            {
                ...
                AmqpTransportSettings = new AmqpTransportSettings { BatchFlushInterval = batchFlushInterval },
                NetMessagingTransportSettings = new NetMessagingTransportSettings { BatchFlushInterval = batchFlushInterval },
            };
        ...
        public async Task UseAzureServiceBus_GivenConfigurationOptions_ThenValid()
        {
            ...
            configurationBuilder.AddInMemoryCollection(new[]
            {
                ...
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:BatchFlushInterval", options.BatchFlushInterval.ToString()),

                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:AmqpTransportSettings:UseSslStreamSecurity", options.AmqpTransportSettings.UseSslStreamSecurity.ToString()),
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:AmqpTransportSettings:MaxFrameSize", options.AmqpTransportSettings.MaxFrameSize.ToString()),
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:AmqpTransportSettings:BatchFlushInterval", options.AmqpTransportSettings.BatchFlushInterval.ToString()),
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:AmqpTransportSettings:EnableReceiverRuntimeMetric", options.AmqpTransportSettings.EnableReceiverRuntimeMetric.ToString()),
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:AmqpTransportSettings:EnableLinkRedirect", options.AmqpTransportSettings.EnableLinkRedirect.ToString()),

                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:NetMessagingTransportSettings:BatchFlushInterval", options.NetMessagingTransportSettings.BatchFlushInterval.ToString()),
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:NetMessagingTransportSettings:EnableRedirect", options.NetMessagingTransportSettings.EnableRedirect.ToString()),
                KeyValuePairFactory.Create("MassTransit:AzureServiceBus:NetMessagingTransportSettings:LeaseTimeout", options.NetMessagingTransportSettings.LeaseTimeout.ToString()),
            });
